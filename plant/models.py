...
class Plant(TimeStamp):
    ...
    other_resources_links = ArrayField(models.CharField(
        unique=True, validators=[validate_link]), size=5, unique=True, null=True, blank=True, validators=[validate_array_length])
